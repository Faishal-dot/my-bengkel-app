...
<head>
    ...
    <style>
        /* CSS Animasi dari Welcome Blade */
        .bg-fade {
            position: absolute;
            inset: 0;
        ...
        <div class="relative z-10 w-full px-4 sm:px-6 lg:px-8 flex justify-center">
            <div class="w-full max-w-md bg-white/10 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl fade-in">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="mt-2 text-gray-300 text-sm">Masuk untuk mengelola kendaraan Anda</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between text-sm">
                        <label class="flex items-center gap-2 text-gray-300 hover:text-white cursor-pointer transition">
                            <input type="checkbox" name="remember" class="rounded border-gray-600 bg-white/5 text-blue-500 focus:ring-offset-gray-900 focus:ring-blue-500">
                            <span>Ingat saya</span>
                        </label>
                        
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-blue-400 hover:text-blue-300 font-medium transition">
                                Lupa password?
                            </a>
                        @endif
                    </div>
                    ...
                    <button type="submit" 
                        class="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-blue-500/30 transition-all transform hover:-translate-y-0.5 flex items-center justify-center gap-2">
                    ...
                    <div class="text-center pt-2">
                        <p class="text-sm text-gray-400">
                            Belum punya akun? 
                            <a href="{{ route('register') }}" class="text-blue-400 hover:text-blue-300 font-bold transition ml-1 hover:underline">
                                Daftar disini
                            </a>
                        </p>
                    </div>
