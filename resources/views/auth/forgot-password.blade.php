...
<head>
    ...
    <title>Lupa Password - Bengkel Oto</title>
    ...
    <style>
        /* CSS Animasi (Sama dengan Login/Register) */
        .bg-fade {
            position: absolute;
            inset: 0;
...
<body class="font-sans antialiased text-white">
    ...
    <div id="slideshow" class="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-black py-10">
        ...
        <div class="absolute top-6 left-6 z-20">
            <a href="{{ route('login') }}" class="flex items-center gap-2 text-gray-300 hover:text-white transition text-sm font-medium">
        ...
        <div class="relative z-10 w-full px-4 sm:px-6 lg:px-8 flex justify-center">
            <div class="w-full max-w-md bg-white/10 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl fade-in">
                ...
                <div class="text-center mb-6">
                    ...
                    <p class="mt-2 text-gray-300 text-sm">Lupa kata sandi? Tidak masalah.</p>
                </div>
                ...
                {{-- Session Status --}}
                @if (session('status'))
                    <div class="mb-4 text-sm font-medium text-green-400 text-center bg-green-500/10 p-3 rounded-xl border border-green-500/20">
                        {{ session('status') }}
                    </div>
                @endif
